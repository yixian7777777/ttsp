...
def test_static_power():
    run(['ttsp','fastDVFS'], get_instance('parsec-canneal', 2, input_set='simsmall'))
    #run(['tsp','fastDVFS'], get_instance('parsec-blackscholes', 4, input_set='simsmall'))
...
def batch_experiment():
    for benchmark in (
        ...
        run(['ttsp','fastDVFS','coreA'], get_instance(benchmark, 4, input_set='small'))
    run(['ttsp','fastDVFS','coreA'], get_instance('parsec-fluidanimate', 3, input_set='small'))
        #run(['ttsp','slowDVFS'], get_instance(benchmark, 4, input_set='simsmall'))
        #run(['tsp','slowDVFS'], get_instance(benchmark, 4, input_set='simsmall'))
    

def motivational_ttsp1():
    run(['ttsp','fastDVFS','coreS'], get_instance('parsec-blackscholes',2, input_set='small'))
    run(['ttsp','fastDVFS','coreM'], get_instance('parsec-canneal',2, input_set='small'))
    
def motivational_ttsp2():
    run(['ttsp','fastDVFS','coreS'], get_instance('parsec-fluidanimate',2, input_set='small'))
    run(['ttsp','fastDVFS','coreM'], get_instance('parsec-streamcluster',2, input_set='small'))

def motivational_ttsp3():
    run(['ttsp','fastDVFS','coreS'], get_instance('parsec-swaptions',2, input_set='small'))
    run(['ttsp','fastDVFS','coreM'], get_instance('splash2-barnes',2, input_set='small'))
    
def motivational_ttsp4():
    run(['ttsp','fastDVFS','coreS'], get_instance('splash2-cholesky',2, input_set='small'))
    run(['ttsp','fastDVFS','coreM'], get_instance('splash2-fft',2, input_set='small'))
    
def motivational_ttsp5():
    run(['ttsp','fastDVFS','coreS'], get_instance('splash2-fmm',2, input_set='small'))
    run(['ttsp','fastDVFS','coreM'], get_instance('splash2-lu.cont',2, input_set='small'))

def motivational_ttsp6():
    run(['ttsp','fastDVFS','coreS'], get_instance('splash2-lu.ncont',2, input_set='small'))
    run(['ttsp','fastDVFS','coreM'], get_instance('splash2-ocean.cont',2, input_set='small'))
    
def motivational_ttsp7():
    run(['ttsp','fastDVFS','coreS'], get_instance('splash2-ocean.ncont',2, input_set='small'))
    run(['ttsp','fastDVFS','coreM'], get_instance('splash2-radiosity',2, input_set='small'))


def motivational_ttsp8():
    run(['ttsp','fastDVFS','coreS'], get_instance('splash2-radix',2, input_set='small'))
    run(['ttsp','fastDVFS','coreM'], get_instance('splash2-raytrace',2, input_set='small'))
    
def motivational_ttsp9():
    run(['ttsp','fastDVFS','coreS'], get_instance('splash2-water.nsq',2, input_set='small'))
    run(['ttsp','fastDVFS','coreM'], get_instance('splash2-water.sp',2, input_set='small'))
